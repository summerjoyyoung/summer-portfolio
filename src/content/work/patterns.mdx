...
<img
  ...
  alt="Animation showing the drag handle between the code panel and API reference being dragged to resize the split"
  style="width: 100%; margin-top: 16px; margin-bottom: 16px;"
/>
...
<img
  ...
  alt="Animation showing the preview viewport being resized with the drag handle on the Preview tab"
  style="width: 100%; margin-top: 16px; margin-bottom: 16px;"
/>
