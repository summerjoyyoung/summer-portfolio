...
img: /assets/page-actions/page-actions.png
img_alt: Screenshot of Visa's Product Design System documentation page showing the page-level copy and view actions in context.
description: |
