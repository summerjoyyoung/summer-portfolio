...
<table>
  ...
  <tbody>
    <tr>
      <td>
        PayPal button on almost every website checkout and 2-3 click user flow
        to complete purchase
      </td>
      <td>
        Take advantage of PayPal’s lack of transparency when they withhold user
        funds by improving this experience
      </td>
    </tr>
    <tr>
      <td>
        Customer trust and loyalty built from being the longest online
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        UX lacks proper explanation of why peoples funds are being held up. May
        reviews of the app claim that PayPal will hold their funds for a long
        time and not clearly explain why
      </td>
      <td>
        Google Pay, Apple Pay, Samsung Pay support online transactions but also
        a digital wallet on their hardware phones that allows users to pay
        physically in store
      </td>
    </tr>
    <tr>
      <td>
        Lacks social-ness. Apps like Venmo emphasize a social UX which show you
        your friends transactions
      </td>
      <td>
        Cash based economies. Some economies (ex. Japan) still revolve heavily
        around cash systems and in-person purchases.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Better customer service that is quick clear and easy in moments of
        frustration
      </td>
    </tr>
    <tr>
    ...
    <td>
      Not profitable at the moment, no fees for the user, company is focusing on
      making it a good product to attract users before making it profitable
    </td>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        Poor customer service when something in the app goes wrong according to
        reviews from the google play store
      </td>
      <td>
        Amazon Pay and Ali Pay offer digital payment which is convenient since
        much of the population has an account with their payment info already
        saved
      </td>
    </tr>
    <tr>
      <td>
        Split branding & experiences between Google Wallet & Pay causes user
        confusion about function of both app
      </td>
      <td>
        Line pay, WeChat pay and Venmo are all more social media focused payment
        apps which are popular around the world
      </td>
    </tr>
  </tbody>
</table>
...
<ImageSlideshow
  ...
  images={[
    {
      src: '/assets/pluto-pay/persona-lacy.jpeg',
      alt: 'User personas for PlutoPay',
    },
    {
      src: '/assets/pluto-pay/persona-jazz.jpeg',
      alt: 'User personas for PlutoPay',
    },
    {
      src: '/assets/pluto-pay/persona-sam.jpeg',
      alt: 'User personas for PlutoPay',
    },
  ]}
/>
  ...
  images={[
    {
      ...
      alt: 'User journeys for PlutoPay',
    },
    {
  ...
  images={[
    {
      ...
      alt: 'High fidelity wireframe - Start screen',
    },
    {
      src: '/assets/pluto-pay/high-fid/Sign-up - Empty.png',
      alt: 'High fidelity wireframe - Sign up empty screen',
    },
    {
      src: '/assets/pluto-pay/high-fid/Sign-up complete.png',
      alt: 'High fidelity wireframe - Sign up complete screen',
    },
    {
      src: '/assets/pluto-pay/high-fid/Account Recovery - Empty.png',
      alt: 'High fidelity wireframe - Account recovery empty screen',
    },
    {
      src: '/assets/pluto-pay/high-fid/Dashboard - Filled.png',
      alt: 'High fidelity wireframe - Dashboard filled screen',
    },
    {
      src: '/assets/pluto-pay/high-fid/Pay Form.png',
      alt: 'High fidelity wireframe - Pay form screen',
    },
    {
      src: '/assets/pluto-pay/high-fid/Pay Form - Search.png',
      alt: 'High fidelity wireframe - Pay form search screen',
    },
    {
      src: '/assets/pluto-pay/high-fid/Pick Payment.png',
      alt: 'High fidelity wireframe - Pick payment screen',
    },
    {
      src: '/assets/pluto-pay/high-fid/Pay Confirmation.png',
      alt: 'High fidelity wireframe - Pay confirmation screen',
    },
    {
      src: '/assets/pluto-pay/high-fid/Payment Complete.png',
      alt: 'High fidelity wireframe - Payment complete screen',
    },
    {
      src: '/assets/pluto-pay/high-fid/Add Payment - Card - Input + Filled.png',
      alt: 'High fidelity wireframe - Add payment card input filled screen',
    },
    {
      src: '/assets/pluto-pay/high-fid/Payment Added.png',
      alt: 'High fidelity wireframe - Payment added screen',
    },
  ]}
/>
...
<ImageSlideshow
  ...
  images={[
    {
      src: '/assets/pluto-pay/usr-test-labels.jpeg',
      alt: 'User journeys for PlutoPay',
    },
    {
      src: '/assets/pluto-pay/usr-test-edit.jpeg',
      alt: 'User journeys for PlutoPay',
    },
    {
      src: '/assets/pluto-pay/usr-test-slider.jpeg',
      alt: 'User journeys for PlutoPay',
    },
  ]}
/>
...
<ImageSlideshow
  ...
  images={[
    {
      src: '/assets/pluto-pay/peer-collab-btn-size.jpeg',
      alt: 'User journeys for PlutoPay',
    },
    {
      src: '/assets/pluto-pay/peer-collab-data.jpeg',
      alt: 'User journeys for PlutoPay',
    },
    {
      src: '/assets/pluto-pay/peer-collab-forgot-pw.jpeg',
      alt: 'User journeys for PlutoPay',
    },
  ]}
/>
