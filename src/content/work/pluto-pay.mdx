...
tags:
  - Design
  - Case Study
role: Solo UX designer — research, IA, wireframing, prototyping, user testing, accessibility annotations, design system
...
<Callout label="The opportunity">
  One secure place to consolidate payment methods, pay without exposing card
  details, and stop overspending — before the limit, not after.
</Callout>
...
<Note accent>Affinity mapping pulled 6 themes out of the noise.</Note>
...
<Note>Two pain points became the primary design targets.</Note>
...
<Note>Cut top-level sections until the IA matched real tasks.</Note>
...
<PullQuote cite="The pay/request slider was a good failure — clarity beat cleverness.">
  “79% of users wanted buttons with words on them.”
</PullQuote>
...
<Note accent>
  Error states got extra care — an unclear message is a trust problem.
</Note>
...
<Note>Learn a system's conventions before diverging from it.</Note>
